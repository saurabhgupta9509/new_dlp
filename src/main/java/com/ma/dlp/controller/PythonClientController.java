...
//
//            // Real-time broadcast
//            Long agentId = resolveAgentId(deviceId);
//            if (agentId != null) {
//                try {
//                    String dest = String.format("/topic/agent/%d/logs", agentId);
//                    simpMessagingTemplate.convertAndSend(dest, logData);
//                } catch (Exception e) {
//                    logger.error("Failed to broadcast Python logs: {}", e.getMessage());
//                }
//            }
//
...
//                    simpMessagingTemplate.convertAndSend(dest, urlData);
//                } catch (Exception e) {
//                    logger.error("Failed to broadcast Python URLs: {}", e.getMessage());
//                }
//            }
//
...
//                    simpMessagingTemplate.convertAndSend(dest, appData);
//                } catch (Exception e) {
//                    logger.error("Failed to broadcast Python app usage: {}", e.getMessage());
//                }
//            }
//
...
//    }
//
//    private Long resolveAgentId(String deviceId) {
//        if (deviceId == null)
//            return null;
//        // Try MAC first
//        List<User> agentsWithMac = userRepository.findAllByMacAddress(deviceId);
//        if (!agentsWithMac.isEmpty()) {
//            return agentsWithMac.get(0).getId();
//        }
//        // Try Hostname
//        return userRepository.findByHostname(deviceId)
//                .map(User::getId)
//                .orElse(null);
//    }
//
...
//                    .ok(new ApiResponse<>(true, "Certificate generation triggered for device: " + deviceId));
//        } catch (Exception e) {
...
//
//            logger.info("🔄 Partial access site toggled: {} -> {}", entity.getUrlPattern(),
